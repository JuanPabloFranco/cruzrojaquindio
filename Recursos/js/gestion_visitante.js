    ...
    function buscarGestionUsuarios(consulta) {
        ...
        $.post('../Controlador/usuario_controler.php', { consulta, funcion}, (response) => {
            ...
            usuarios.forEach(usuario => {
                ...
                if(usuario.nacionalidad=="COLOMBIANO/A"){
                    residencia = usuario.municipio + " ("+ usuario.departamento + ")";
                }
                  ...
                  <div class="card-body pt-0">
                    <div class="row">
                      <div class="col-8">
                        ...
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-building"></i></span> Documento: ${usuario.doc_id}</li>
                        ...
                        <li class="small"><span class="fa-li"><i class="fas fa-lg fa-sitemap"></i></span> Residencia: ${residencia}</li>
                        </ul>`;
